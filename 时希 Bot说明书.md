...
| **指令** | **别名** | **范围** | **说明** |
| --- | --- | --- | --- |
| 开箱 [数量] [名称] | csgo开箱 | 群聊 | 开启武器箱 |
| 武器箱列表 | csgo武器箱列表 | 群聊 | 查看所有武器箱 |
| 纪念包列表 | csgo纪念包列表 | 群聊 | 查看所有纪念包 |
| 皮肤搜索 [皮肤名] | csgo皮肤搜索 | 群聊 | 搜索皮肤 |
